    ...
    return (
        <section className="portfolio--section" id="MyPortfolio">
            <div className="portfolio--container--box">
                ...
                <div class="githubVisit">
                    <a href="https://github.com/jasleen2005" target="_blank" rel="noopener noreferrer">
                        <button className="btn btn-github">
                            <svg
                                xmlns="https://vendor-management-project-xbe7.vercel.app/landing"
                                width="32"
                                height="32"
                                viewBox="0 0 33 33"
                                fill="none"
                    ...
                    <div key={index} className="portfolio--section--card">
                        ...
                        <div className="portfolio--section--card--content">
                            ...
                            <p className="text-sm portfolio--link">
                                {item.link}
                                <svg
                                    xmlns="https://ecommerce-website-zo2d.vercel.app/"
                                    width="16"
                                    height="16"
                                    viewBox="0 0 20 19"
                                    fill="none"
